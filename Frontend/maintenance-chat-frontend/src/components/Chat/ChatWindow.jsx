...
//   if (loading) {
//     return <div className="chat-window loading">Loading conversation...</div>;
//   }
  
//   if (error) {
//     return <div className="chat-window error">Error: {error}</div>;
//   }
  
//   if (!currentConversation) {
//     return <div className="chat-window not-found">Conversation not found</div>;
//   }
...
//         {isEditMode ? (
//           <form className="edit-conversation-form" onSubmit={handleUpdateConversation}>
//             <input
//               type="text"
//               value={editedTitle}
...
//               <div className="title-with-ai-indicator">
...
//                 {isAIConversation && (
//                   <span className="ai-tag">AI Enabled</span>
//                 )}
//                 {currentConversation.tags && currentConversation.tags.map((tag, index) => (
...
//         {/* AI Help Text */}
//         {isAIConversation && (
//           <div className="ai-help-bar">
//             <span className="ai-help-text">
//               💡 Upload documents and ask any questions. AI will analyze both your files and equipment data.
//             </span>
//           </div>
//         )}
//       </div>
